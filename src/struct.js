...
(function(global, undefined) {
    ...
    var Struct = function(struct, value, endianness) {
        ...
        this._debug && console.log('STRUCT.CREATE', 'defaultValue:', this.defaultValue, 'byteLength:', this.byteLength, 'endianness:', this.endianness, 'struct:', this.struct);
    };
    ...
    Struct.prototype = /** @lends Struct# */
        {
            ...
            read: function(arrayBuffer, offset) {
                ...
                this._debug && console.info('STRUCT.READ', 'byteLength:', arrayBuffer.byteLength, 'readOffset:', this.offset);

                var readed = align(this.struct
                                   /** @exception Will throw an error if uncaught index size */, function(item, prop, struct) {
                        var values = [],
                            typed = item[0],
                            value = item[1],
                            length = item[2],
                ...
                if (!isError(readed)) {
                    ...
                    this.offset != arrayBuffer.byteLength && readed.type >= 200 && this.offset != 6 && console.warn('Incorrect buffer size readed', this.offset, arrayBuffer.byteLength, readed);
                }
            ...
            write: function(struct) {
                ...
                this._debug && console.info('STRUCT.WRITE', 'byteLength:', this.byteLength);
    ...
    function normalize(model, defaultValue) {
        return align(model, function(params, prop, struct) {
            ...
            var _typed = isArray(params) && params[0] || params,
                ...
                ,
                length = isArray(params) && params.length >= 3 && params[2] || (isString(value) || isArray(value) || isArrayBuffer(value)) && value.length //FIXME 0일 수도 있음
                         ||
                         isArrayBuffer(value) && value.byteLength || 1
                // [3] vary, define boolean as vary type from params
                ,
                vary = isArray(params) && (isString(length) || length > 1) ? isString(length) && params[3] === undefined && true || params[3] : false;
    ...
    if (DataView.prototype.getUint64 === undefined && DataView.prototype.setUint64 === undefined && DataView.prototype.getInt64 === undefined && DataView.prototype.setInt64 === undefined) {
